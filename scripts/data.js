...
window.staticData = {
    ...
    equipments: {
        "刀剑": [
            { name: "剥皮羊角刀", type: "匕首", description: "[灵巧][隐匿]草原猎人随身必备的工具与武器。短小精悍，非常适合在极近的距离内发出致命一击，也易于隐藏和快速拔出，是进行隐秘行动或应急自卫的可靠伙伴。" },
            { name: "青锋剑", type: "长剑", description: "[均衡][格挡]怀武国铸剑工艺的典范，剑身修长，刚柔并济。它既能施展势大力沉的劈砍，也能完成精巧的突刺，攻防一体。经过训练的使用者能轻松地用其剑身格挡开敌人的兵刃。" }
        ],
        "枪械": [
            { name: "制式“和平使者”", type: "手枪", description: "[远程][灵巧][响亮]优玛魔法工业的成熟产物，结构紧凑，击发稳定，在近距离交火中占据先机，但巨大的枪声也会暴露你的位置。"}
        ],
        "棍棒锤斧": [
            { name: "军用硬头锤", type: "锤子", description: "[钝击][破甲]经典的帝国制式武器，质朴无华但极其有效。其沉重的头部能传递可怕的冲击力，即便是最精良的铠甲也难以完全化解。对于重甲敌人，它能透过盔甲造成有效的创伤。"}
        ],
        "法器": [
            { name: "冥想之光", type: "法杖", description: "[施法][引导]以德买西亚特有的灵木雕刻而成，顶端镶嵌着能增幅精神力量的宝石。它不仅能提升法术成型的稳定性和威力，还能帮助施法者更高效地引导与控制魔力，降低长时间施法的负担。"},
            { name: "巫傩祭铃", type: "法器", description: "[专注][预兆]源自大魏古老祭祀仪式的青铜铃铛，其上刻有难以解读的符文。摇动时发出的清音能帮助持有者凝神静气，抵御外邪侵扰。有时，它会在危机降临前无风自鸣，给予主人模糊的警示。"},
        ],
        "盾牌": [
            { name: "军团大盾", type: "盾牌", description: "[防护][招架]军团战术的缩影，巨大的长方形盾牌能为使用者提供全方位的可靠防护。坚固的盾面不仅能偏转箭矢和刀剑，熟练的战士还能用它猛地撞开敌人，为反击创造绝佳的机会。"}
        ],
        "护甲": [
            { name: "黑漆胴", type: "护甲", description: "[防护][沉重]武士的传统甲胄，由染漆的竹木与铁片精心扎制而成。它提供了卓越的防护，尤其能有效抵御劈砍和远程射击，但层叠的结构不可避免地会牺牲掉一部分行动的灵活性。"}
        ],
        "鞋履": [
            { name: "沙行靴", type: "鞋履", description: "[舒适][稳健]用沙漠兽皮鞣制而成，靴底宽大且纹路特殊。穿着它在松软的沙地或崎岖的山路上行走如履平地，并能有效防止在战斗中因脚下不稳而失衡摔倒。"}
        ],
        "饰品": [
            { name: "福带", type: "织物", description: "[神圣][庇护][祭祀]常年浸润在神圣气息中的福带，会散发一股令人心安的微光。佩戴者会感到心神宁静，仿佛置身于神山的庇护之下，不易被凡俗的恐惧与幻惑所侵扰。在危急关头，缎带上的神纹会如呼吸般明灭，偏转一次本应命中的厄运。"}
        ]
    },
